...
public class DiskosFaistou extends RareFinding {

    /**
     * <b>Constructor</b>
     * makes the DiskosFaistou with points and its anaktoro
     ...
     */
    public DiskosFaistou(int points, AnaktoroEnum anaktoro) {
    ...
    public void addToSyllogi(Player player) {
        ...
        current_holdings[2] = 1;// faistos is at third position
